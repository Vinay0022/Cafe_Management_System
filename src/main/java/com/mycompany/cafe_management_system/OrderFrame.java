...
import com.mycompany.cafe_management_system.model.Cart;
...
public class OrderFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setFont(new java.awt.Font("JetBrainsMono NF", 1, 24)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Cart ID:");

        jLabel5.setFont(new java.awt.Font("JetBrainsMono NF", 1, 24)); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "You have not purchased anything yet");
        }
        ...
        if (jTextField3.getText().isEmpty()) {
            ...
            try {
                ...
                if (!dao.isProductExist(cid, proId)) {
                    ...
                    JOptionPane.showMessageDialog(this, "Product already exists", "Warning", 2);
                }
            } catch (Exception e) {
